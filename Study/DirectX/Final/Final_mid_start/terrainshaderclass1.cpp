...
TerrainShaderClass1::TerrainShaderClass1()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
TerrainShaderClass1::TerrainShaderClass1(const TerrainShaderClass1& other)
{
}
...
bool TerrainShaderClass1::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"Engine/terrain1.vs", L"Engine/terrain1.ps");
	if(!result)
	{
		return false;
	}
...
void TerrainShaderClass1::Shutdown()
{
...
bool TerrainShaderClass1::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
...
bool TerrainShaderClass1::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void TerrainShaderClass1::ShutdownShader()
{
...
void TerrainShaderClass1::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool TerrainShaderClass1::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
											 XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* normalMap,
											 ID3D11ShaderResourceView* normalMap2, ID3D11ShaderResourceView* normalMap3, 
											 XMFLOAT3 lightDirection, XMFLOAT4 diffuseColor)
{
...
void TerrainShaderClass1::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
