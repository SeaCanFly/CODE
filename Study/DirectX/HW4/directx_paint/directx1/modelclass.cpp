...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	vertices[4].position = D3DXVECTOR3(2.0f, 2.0f, 0.0f); // Bottom left.
	vertices[4].texture = D3DXVECTOR2(0.0f, 1.0f);
	vertices[5].position = D3DXVECTOR3(2.0f, 3.0f, 0.0f); // Top middle.
	vertices[5].texture = D3DXVECTOR2(0.0f, 0.0f);
	vertices[6].position = D3DXVECTOR3(3.0f, 2.0f, 0.0f); // Bottom right.
	vertices[6].texture = D3DXVECTOR2(1.0f, 1.0f);
	vertices[7].position = D3DXVECTOR3(3.0f, 3.0f, 0.0f);
