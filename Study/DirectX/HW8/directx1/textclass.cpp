	...
	D3DXMATRIX baseViewMatrix)
{
	...
	result = UpdateSentence(m_sentence1, "Tank go!", 200, 250, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, "Watch tower", 450, 250, 0.0f, 1.0f, 0.7f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence3, "AWP 1shot 1kill", 200, 550, 0.7f, 0.3f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence4, "Pym", 450, 550, 0.0f, 0.0f, 0.9f, deviceContext);
	if (!result)
	{
		return false;
	}
