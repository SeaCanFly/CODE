...
TerrainCellClass1::TerrainCellClass1()
{
	m_vertexList = 0;
	m_vertexBuffer = 0;
	m_indexBuffer = 0;
...
TerrainCellClass1::TerrainCellClass1(const TerrainCellClass1& other)
{
}
...
bool TerrainCellClass1::Initialize(ID3D11Device* device, void* terrainModelPtr, int nodeIndexX, int nodeIndexY, 
...
void TerrainCellClass1::Shutdown()
{
...
void TerrainCellClass1::Render(ID3D11DeviceContext* deviceContext)
{
...
int TerrainCellClass1::GetVertexCount()
{
	return m_vertexCount;
}


int TerrainCellClass1::GetIndexCount()
{
	return m_indexCount;
}


bool TerrainCellClass1::InitializeBuffers(ID3D11Device* device, int nodeIndexX, int nodeIndexY, int cellHeight, int cellWidth, 
...
void TerrainCellClass1::ShutdownBuffers()
{
...
void TerrainCellClass1::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
void TerrainCellClass1::CalculateCellDimensions()
{
	int i;
...
bool TerrainCellClass1::BuildLineBuffers(ID3D11Device* device)
{
...
void TerrainCellClass1::ShutdownLineBuffers()
{
	// Release the index buffer.
...
void TerrainCellClass1::RenderLineBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
int TerrainCellClass1::GetLineBuffersIndexCount()
{
	return m_lineIndexCount;
}


void TerrainCellClass1::GetCellDimensions(float& maxWidth, float& maxHeight, float& maxDepth, 
