...
// ScrollTestDlg.cpp : implementation file
//
...
CScrollTestDlg::CScrollTestDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CScrollTestDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CScrollTestDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_HSCROLL()
...
// CScrollTestDlg message handlers
...
void CScrollTestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CScrollTestDlg::OnQueryDragIcon()
{
...
//	if (pScrollBar != NULL) {
		CString str;
		str.Format(_T("%d"), pScrollBar->GetScrollPos());
		m_edit.SetWindowText(str);
