...
TerrainClass1::TerrainClass1(const TerrainClass1& other)
{
}
...
bool TerrainClass1::Initialize(ID3D11Device* device, char* setupFilename)
{
	bool result;
...
bool TerrainClass1::LoadSetupFile(char* filename)
{
	int stringLength;
	ifstream fin;
	char input;
...
bool TerrainClass1::LoadRawHeightMap()
{
	int error, i, j, index;
	FILE* filePtr;
...
void TerrainClass1::ShutdownHeightMap()
{
...
void TerrainClass1::SetTerrainCoordinates()
{
	int i, j, index;
...
bool TerrainClass1::CalculateNormals()
{
...
bool TerrainClass1::LoadColorMap()
{
...
bool TerrainClass1::BuildTerrainModel()
{
...
void TerrainClass1::ShutdownTerrainModel()
{
...
void TerrainClass1::CalculateTerrainVectors()
{
...
void TerrainClass1::CalculateTangentBinormal(TempVertexType vertex1, TempVertexType vertex2, TempVertexType vertex3, VectorType& tangent, VectorType& binormal)
{
...
bool TerrainClass1::LoadTerrainCells(ID3D11Device* device)
{
	...
	m_TerrainCells = new TerrainCellClass1[m_cellCount];
	if(!m_TerrainCells)
	{
		return false;
	}
...
void TerrainClass1::ShutdownTerrainCells()
{
	int i;
...
bool TerrainClass1::RenderCell(ID3D11DeviceContext* deviceContext, int cellId, FrustumClass* Frustum)
{
...
void TerrainClass1::RenderCellLines(ID3D11DeviceContext* deviceContext, int cellId)
{
...
int TerrainClass1::GetCellIndexCount(int cellId)
{
	return m_TerrainCells[cellId].GetIndexCount();
}


int TerrainClass1::GetCellLinesIndexCount(int cellId)
{
	return m_TerrainCells[cellId].GetLineBuffersIndexCount();
}


int TerrainClass1::GetCellCount()
{
	return m_cellCount;
}


int TerrainClass1::GetRenderCount()
{
	return m_renderCount;
}


int TerrainClass1::GetCellsDrawn()
{
	return m_cellsDrawn;
}


int TerrainClass1::GetCellsCulled()
{
	return m_cellsCulled;
}


bool TerrainClass1::GetHeightAtPosition(float inputX, float inputZ, float& height)
{
	int i, cellId, index;
...
bool TerrainClass1::CheckHeightOfTriangle(float x, float z, float& height, float v0[3], float v1[3], float v2[3])
{
