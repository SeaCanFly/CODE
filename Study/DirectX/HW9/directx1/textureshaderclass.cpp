	...
	D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	...
	//The SetShaderParameters function has been modified from the previous tutorial to include setting the texture in the
		//pixel shader now.
...
void TextureShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
	...
	//The RenderShader function has been changed to include setting the sample state in the pixel shader before
		//rendering.
