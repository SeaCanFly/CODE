...
void PositionClass::MoveForward(bool keydown,float speed)
{
	float radians;
	...
	if(keydown)
	{
		m_forwardSpeed += m_frameTime * 1.0f*speed;
		if(m_forwardSpeed > (m_frameTime * 50.0f*speed))
		{
			m_forwardSpeed = m_frameTime * 50.0f*speed;
		}
	}
	else
	{
		/*m_forwardSpeed -= m_frameTime * 0.5f*speed;
...
void PositionClass::MoveBackward(bool keydown,float speed)
{
	float radians;
	...
	if(keydown)
	{
		m_backwardSpeed += m_frameTime * 1.0f*speed;

		if(m_backwardSpeed > (m_frameTime * 50.0f*speed))
		{
			m_backwardSpeed = m_frameTime * 50.0f*speed;
		}
	}
	else
	{
		//m_backwardSpeed -= m_frameTime * 0.5f*speed;
